...
const Footer = () => {
    ...
    let icon = (
        <a href="https://github.com/lucabk/Registro-Elettronico" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="dark" className="bi bi-github" viewBox="0 0 16 16">
    ...
    switch(user?.role){
        ...
        case "ROLE_STU":
            content = (
            <footer className="mt-2 mb-0 p-3 bg-success text-dark fixed-bottom">
                {icon}
            </footer>
            )
            break
